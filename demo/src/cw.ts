...
// testing your aws cloud watch with this logger as testing logs
const logger = new Logger({
    ...
    transportCloudWatchOptions: {
        ...
        awsSecretKey: 'YYYYYYYYYYYYYYYYYYYY',
        awsRegion: 'eu-north-1',
        level: LOGGER_LEVEL.INFO,
        logStreamName: 'awesome-logs-DATE',
        logGroupName: 'testing',
        retentionInDays: 1,
    },
});

const reqId = '0000-000-000-1111';
